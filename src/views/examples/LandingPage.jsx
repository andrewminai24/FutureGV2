                ...
                <Col lg='6' md='6'>
                  ...
                  <div className='btn-wrapper mb-3'>
                    ...
                    <Button
                      ...
                      size='medium'
                    >
                      <div style={{ marginBottom: '0rem !important' }} className='btn-wrapper'>
                        <p className='category text-success d-inline'>
                          VR simulation
                        </p>
                        <Button
                  ...
                  <div className='btn-wrapper'>
                    <div className='button-container'>
                      ...
                      <Button
                        className='btn-icon btn-simple btn-round btn-neutral'
                        color='default'
                        href='https://bobguy1234.github.io/'
                        onClick={e => e.preventDefault()}
                      >
                  ...
                  <Row className='row-grid justify-content-center'>
                    <Col lg='3'>
                      <div className='info'>
                        ...
                        <h4 className='info-title'>Earn more</h4>
                        <hr className='line-primary' />
                        <p>
                          When being able to work within your passion.You are
                          going to be able to get more work done within work
                          that you love
                        </p>
                      </div>
                    </Col>
                    ...
                    <ul className='list-unstyled mt-5'>
                      ...
                      <li className='py-2'>
                        <div className='d-flex align-items-center'>
                          ...
                          <div className='ml-3'>
                            <h6>Interactive role playing sessions</h6>
                          </div>
                        </div>
                      </li>
                      <li className='py-2'>
